...
public class CASImpl extends AbstractCas_ImplBase
  ...
  static class SharedViewData {
    ...
    private int getNextFsId(TOP fs) {
      ...
      Backend backend = baseCAS.backend();
      if (backend != null) {
        CASImpl view = fs._casView;
        int viewId = (view.mySofaRef == null) ? 1 : view.mySofaRef.getSofaNum();
        int fsRef = backend.lifecycle().allocateFsId(fs._getTypeCode(), viewId);
        backend.lifecycle().onFsCreated(fsRef, fs._getTypeCode(), viewId);
        return fsRef;
      }
  ...
  public void backend(Backend backend) {
    svd.backend = backend;
  }
  ...
  public int ll_getArraySize(int id) {
    ...
    if (backend != null) {
      TOP fs = getFsFromId_checked(id);
      switch (fs._getTypeCode()) {
        case fsArrayTypeCode:
          return backend.arrays().sizeFsArray(id);
        case intArrayTypeCode:
          return backend.arrays().sizeIntegerArray(id);
        case floatArrayTypeCode:
          return backend.arrays().sizeFloatArray(id);
        case stringArrayTypeCode:
          return backend.arrays().sizeStringArray(id);
        case booleanArrayTypeCode:
          return backend.arrays().sizeBooleanArray(id);
        case byteArrayTypeCode:
          return backend.arrays().sizeByteArray(id);
        case shortArrayTypeCode:
          return backend.arrays().sizeShortArray(id);
        case longArrayTypeCode:
          return backend.arrays().sizeLongArray(id);
        case doubleArrayTypeCode:
          return backend.arrays().sizeDoubleArray(id);
        default:
          break;
      }
    }
  ...
  private String getStringForCode(int i) {
    Backend backend = backend();
    if (backend != null) {
      return backend.strings().getStringForCode(i);
    }
  ...
  private int getCodeForString(String s) {
    Backend backend = backend();
    if (backend != null) {
      return backend.strings().getCodeForString(s);
    }
    if (null == svd.llstringSet) {
  ...
  public final int ll_getIntArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getIntegerArrayValue(fsRef, position);
    }
  ...
  public final float ll_getFloatArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getFloatArrayValue(fsRef, position);
    }
  ...
  public final String ll_getStringArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getStringArrayValue(fsRef, position);
    }
  ...
  public final int ll_getRefArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getFsArrayRefValue(fsRef, position);
    }
  ...
  public void ll_setIntArrayValue(int fsRef, int position, int value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setIntegerArrayValue(fsRef, position, value);
      return;
    }
  ...
  public void ll_setFloatArrayValue(int fsRef, int position, float value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setFloatArrayValue(fsRef, position, value);
      return;
    }
  ...
  public void ll_setStringArrayValue(int fsRef, int position, String value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setStringArrayValue(fsRef, position, value);
      return;
    }
  ...
  public void ll_setRefArrayValue(int fsRef, int position, int value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setFsArrayRefValue(fsRef, position, value);
      return;
    }
  ...
  public byte ll_getByteArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getByteArrayValue(fsRef, position);
    }
  ...
  public boolean ll_getBooleanArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getBooleanArrayValue(fsRef, position);
    }
  ...
  public short ll_getShortArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getShortArrayValue(fsRef, position);
    }
  ...
  public long ll_getLongArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getLongArrayValue(fsRef, position);
    }
  ...
  public double ll_getDoubleArrayValue(int fsRef, int position) {
    Backend backend = backend();
    if (backend != null) {
      return backend.arrays().getDoubleArrayValue(fsRef, position);
    }
  ...
  public void ll_setByteArrayValue(int fsRef, int position, byte value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setByteArrayValue(fsRef, position, value);
      return;
    }
  ...
  public void ll_setBooleanArrayValue(int fsRef, int position, boolean b) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setBooleanArrayValue(fsRef, position, b);
      return;
    }
  ...
  public void ll_setShortArrayValue(int fsRef, int position, short value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setShortArrayValue(fsRef, position, value);
      return;
    }
  ...
  public void ll_setLongArrayValue(int fsRef, int position, long value) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setLongArrayValue(fsRef, position, value);
      return;
    }
  ...
  public void ll_setDoubleArrayValue(int fsRef, int position, double d) {
    Backend backend = backend();
    if (backend != null) {
      backend.arrays().setDoubleArrayValue(fsRef, position, d);
      return;
    }
