...
public final class BooleanArray extends TOP
  ...
  public BooleanArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeBooleanArray(_id, length);
    }
  }
  ...
  public BooleanArray(TypeImpl t, CASImpl c, int l) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeBooleanArray(_id, l);
    }
  }
  ...
  public boolean get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getBooleanArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, boolean v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setBooleanArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(boolean[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromBooleanArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, boolean[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToBooleanArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeBooleanArray(_id);
    }
  ...
  public void copyToArray(int srcPos, String[] dest, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      dest[i + destPos] = Boolean.toString(get(i + srcPos));
    }
  }
  ...
  public void copyFromArray(String[] src, int srcPos, int destPos, int length) {
    _casView.checkArrayBounds(size(), srcPos, length);
    for (int i = 0; i < length; i++) {
      set(i + destPos, Boolean.parseBoolean(src[i + srcPos]));
    }
  }
