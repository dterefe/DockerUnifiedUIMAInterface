...
public final class ByteArray extends TOP
  ...
  public ByteArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeByteArray(_id, length);
    }
  }
  ...
  public byte get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getByteArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, byte v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setByteArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(byte[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromByteArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, byte[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToByteArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeByteArray(_id);
    }
  ...
  public void copyToArray(int srcPos, String[] dest, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      dest[i + destPos] = Byte.toString(get(i + srcPos));
    }
  }
  ...
  public void copyFromArray(String[] src, int srcPos, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      set(i + destPos, Byte.parseByte(src[i + srcPos]));
    }
  }
