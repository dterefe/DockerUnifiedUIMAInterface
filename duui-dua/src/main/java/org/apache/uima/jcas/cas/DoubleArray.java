...
public final class DoubleArray extends TOP
  ...
  public DoubleArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeDoubleArray(_id, length);
    }
  }
  ...
  public double get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getDoubleArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, double v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setDoubleArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(double[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromDoubleArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, double[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToDoubleArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeDoubleArray(_id);
    }
  ...
  public void copyToArray(int srcPos, String[] dest, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      dest[i + destPos] = Double.toString(get(i + srcPos));
    }
  }
  ...
  public void copyFromArray(String[] src, int srcPos, int destPos, int length) {
    _casView.checkArrayBounds(size(), destPos, length);
    for (int i = 0; i < length; i++) {
      set(i + destPos, Double.parseDouble(src[i + srcPos]));
    }
  }
