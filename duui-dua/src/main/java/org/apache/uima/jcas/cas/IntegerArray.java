...
public final class IntegerArray extends TOP
  ...
  public IntegerArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeIntegerArray(_id, length);
    }
  }
  ...
  public int get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getIntegerArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, int v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setIntegerArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(int[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromIntegerArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, int[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToIntegerArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeIntegerArray(_id);
    }
