...
public final class LongArray extends TOP
  ...
  public LongArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeLongArray(_id, length);
    }
  }
  ...
  public long get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getLongArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, long v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setLongArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(long[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromLongArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, long[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToLongArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeLongArray(_id);
    }
  ...
  public void copyToArray(int srcPos, String[] dest, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      dest[i + destPos] = Long.toString(get(i + srcPos));
    }
  }
  ...
  public void copyFromArray(String[] src, int srcPos, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      set(i + destPos, Long.parseLong(src[i + srcPos]));
    }
  }
