...
public final class ShortArray extends TOP
  ...
  public ShortArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeShortArray(_id, length);
    }
  }
  ...
  public short get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getShortArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, short v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setShortArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(short[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromShortArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, short[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToShortArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeShortArray(_id);
    }
  ...
  public void copyToArray(int srcPos, String[] dest, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      dest[i + destPos] = Short.toString(get(i + srcPos));
    }
  }
  ...
  public void copyFromArray(String[] src, int srcPos, int destPos, int length) {
    ...
    for (int i = 0; i < length; i++) {
      set(i + destPos, Short.parseShort(src[i + srcPos]));
    }
  }
