...
public final class StringArray extends TOP
  ...
  public StringArray(JCas jcas, int length) {
    ...
    if (_casView.backend() != null) {
      _casView.backend().arrays().initializeStringArray(_id, length);
    }
  }
  ...
  public String get(int i) {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().getStringArrayValue(_id, i);
    }
    return theArray[i];
  }
  ...
  public void set(int i, String v) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().setStringArrayValue(_id, i, v);
    } else {
      theArray[i] = v;
    }
  ...
  public void copyFromArray(String[] src, int srcPos, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyFromStringArray(_id, destPos, src, srcPos, length);
    } else {
  ...
  public void copyToArray(int srcPos, String[] dest, int destPos, int length) {
    if (_casView.backend() != null) {
      _casView.backend().arrays().copyToStringArray(_id, srcPos, dest, destPos, length);
    } else {
  ...
  public int size() {
    if (_casView.backend() != null) {
      return _casView.backend().arrays().sizeStringArray(_id);
    }
  ...
  public boolean contains(String v) {
    return Misc.contains(toArray(), v);
  }
