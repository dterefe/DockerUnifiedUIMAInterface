...
public final class GerParCorDocumentHandler implements IDUUIDocumentHandler {
    private final DUUIMongoDBConnectionHandler mongo;
     ...
     */
    public GerParCorDocumentHandler(DUUIMongoDBConnectionHandler mongo, GridFSBucket gridFS, String queryJson, boolean overrideMeta) {
        this.mongo = mongo;
        this.gridFS = gridFS;
